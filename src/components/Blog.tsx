...
const Blog = () => {
  return (
    <>
      <div
        id="blog"
        className="lg:mt-8 xl:mt-10 text-center relative xl:max-w-[1440px] mx-auto px-4"
      >
        <h1 className="romanesco text-[36px] lg:text-[44px] xl:text-[48px] text-[#0F172A] text-center">
          Blogs
        </h1>
        <h1 className="rouge text-[36px] lg:text-[40px] xl:text-[48px] text-[#0F172A] text-center -mt-1">
          Hotel Supply Innovations
        </h1>
        <p className="lg:text-[16px] xl:text-[20px] satoshi text-black/60 lg:w-[950px] xl:w-[1280px] mx-auto text-center lg:mt-4 xl:mt-6">
        ...
        <div className="mx-auto w-full md:w-[90vw] lg:w-[980px] xl:w-[1280px] py-4 z-50 relative mt-6">
          {/* Slider */}

          <div className="flex flex-col lg:flex-row justify-start lg:justify-between items-start lg:items-start">
            {blog.map((blog) => (
              <div key={blog.id} className="py-5 px-2">
                <div className="w-full lg:w-[300px] xl:w-[395px] mx-auto rounded-[8px] border-[1px] border-[#0F172A] hover:shadow-lg hover:scale-[1.005] transform transition-all ease-linear duration-300">
                  ...
                  />
                  <div className="px-2 pt-2 lg:px-5 xl:px-6 lg:pt-3 xl:pt-4 pb-2 lg:pb-3 xl:pb-4">
                    <h2 className="mt- md:mt-3 text-[18px] lg:text-[18px] xl:text-[24px] poltawski font-semibold lg:leading-[22px] xl:leading-[23px] md:leading-8 text-start text-[#282A3A]">
                      {blog.title}
                    </h2>
                    <p className="mt-3 lg:mt-2 xl:mt-4 text-[13px] lg:text-[13px] xl:text-[16px] barlow font-light leading-[150%] text-start text-[#282A3A]">
                      {blog.description}
                    </p>
                    <div className="flex justify-end items-center">
                      ...
                      >
                        <Button className="text-center rounded-2xl px-3 py-2 md:px-4 md:py-2 lg:text-[13px] xl:text-[16px] flex items-center gap-x-2 text-[#701A75] bg-white">
                          Read article{" "}
                          <img
                            className="w-[20px] lg:ww-[20px] xl:w-[24px]"
                            src={ArrowRight}
                            alt=""
                          />
                        </Button>
